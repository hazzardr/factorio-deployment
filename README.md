...
The factorio server version is defined in the `docker-compose.yml` as an ARG. You will have to force rebuild the container via `docker compose up --build -d`

This image expects volumes defined in a `/home/factorio` path, and I personally use the following settings (removed password):
